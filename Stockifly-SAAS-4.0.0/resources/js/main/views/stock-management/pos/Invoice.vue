<template>
  ...
  <div class="bill-party-left">
    ...
    <!-- Customer Name (from order or localStorage) -->
    ...
    <!-- Address (from localStorage if not in order.user) -->
    <p v-if="finalCustomerAddress" class="party-line">
      {{ finalCustomerAddress }}
    </p>
  </div>

  <!-- RIGHT SIDE: Generated By + Time + Warehouse City/State -->
  <div class="bill-party-right">
    <div class="generated-info">
      <p class="party-line text-right">
        <strong>Generated by:</strong> {{ displayName || 'Admin' }}
      </p>
      <p class="party-line text-right">
        <strong>Report Generated At:</strong><br>
        {{ currentTime }}
      </p>
    </div>

    <div class="warehouse-location mt-4">
      <p v-if="selectedWarehouse.city" class="party-line text-right">
        {{ selectedWarehouse.city }}
      </p>
      <p v-if="selectedWarehouse.state" class="party-line text-right">
