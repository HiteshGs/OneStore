                ...
                <div class="md:max-w-xl">
                    ...
                    <div class="register-div">
                        <div class="flex flex-wrap -m-2 mb-6">
                            ...
                            @if($isSubdomainModuleInstalled)
                           <div class="form-group w-full p-2">
                                <div class="flex rounded-lg border border-gray-200 overflow-hidden">
                                    <input
                                        class="form-control flex-1 px-5 py-3.5 text-gray-500 placeholder-gray-500 bg-white outline-none focus:ring-4 focus:ring-indigo-500"
                                        type="text"
                                        placeholder="{{ $frontSetting?->register_subdomain_text ?? 'Subdomain' }}"
                                        id="subdomain"
                                        name="subdomain"
                                    >
                                    <span class="px-4 py-3.5 bg-gray-100 text-gray-600 text-sm whitespace-nowrap">
                                        <b>{{ $domainName ?? '' }}</b>
                                    </span>
                                </div>
                                <div></div>
                            ...
                            <div class="form-group w-full p-2">
                                <input class="form-control w-full px-5 py-3.5 text-gray-500 placeholder-gray-500 bg-white outline-none focus:ring-4 focus:ring-indigo-500 border border-gray-200 rounded-lg"
                                    type="text" placeholder="{{ $frontSetting->register_phone_text ?? 'Phone' }}" id="company_phone" name="company_phone">
                            </div>
                            <div class="form-group w-full p-2">
                                <input class="form-control w-full px-5 py-3.5 text-gray-500 placeholder-gray-500 bg-white outline-none focus:ring-4 focus:ring-indigo-500 border border-gray-200 rounded-lg"
