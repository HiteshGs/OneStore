                                    ...
                                    <a-form layout="vertical">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col
                                                :xs="24"
                                                :sm="24"
                                                :md="isSubdomainModuleEnabled ? 12 : 24"
                                                :lg="isSubdomainModuleEnabled ? 12 : 24"
                                            >
                                                <a-form-item
                                                    :label="
                                                        $t(
                                            ...
                                            >
                                                <a-form-item
                                                    :label="
                                                        $t(
                                                            'website_settings.register_subdomain_text'
                                                        )
                                                    "
                                                    name="register_subdomain_text"
                                                    :help="
                                                        rules.register_subdomain_text
                                                            ? rules
                                                                  .register_subdomain_text
                                                                  .message
                                                            : null
                                                    "
                                                    :validateStatus="
                                                ...
                                                >
                                                    <a-input
                                                        v-model:value="
                                                            formData.register_subdomain_text
                                                        "
                                                        :placeholder="
                                                            $t(
                                                                'common.placeholder_default_text',
                                        ...
                                        <a-row :gutter="16">
                                            ...
                                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                                <a-form-item
                                                    :label="
                                                        $t(
                                                            'website_settings.register_phone_text'
                                                        )
                                                    "
                                                    name="register_phone_text"
                                                    :help="
                                                        rules.register_phone_text
                                                            ? rules.register_phone_text
                                                                  .message
                                                            : null
                                                    "
